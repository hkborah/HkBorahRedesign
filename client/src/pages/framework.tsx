...
import { ASFDiagram } from "@/components/framework/asf-diagram";
      ...
      <div className="min-h-screen bg-slate-950 flex flex-col">
        ...
        <div className="container mx-auto px-6 py-12 max-w-7xl space-y-24">
            ...
            <div className="space-y-12">
                ...
                {/* ASF Process Diagram - SVG Based */}
                <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-8 flex justify-center">
                    <ASFDiagram />
                </div>
            </div>
